...
class ContactsListView {
    ...
    createContact(object) {
        ...
        let listElement = $("<li></li>").attr({ "id": object.id, "class": "candit-details" })
            .append($("<p class='candit-name'></p>").text(object['name']), $("<p class='candit-email'></p>").text(object['email']), $("<p class='candit-contact'></p>").text(object['contactInformation'][0]))
            .on('click', function () {
            var _a;
            ...
            if (url.startsWith('/detailsPage.html')) {
                ...
                (_a = self.detailsView) === null || _a === void 0 ? void 0 : _a.fillData(self.model.getEmployee($(this).attr("id")));
